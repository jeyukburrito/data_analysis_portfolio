...
- 한국전력공사에서 제공하는 일 별 전력 사용량 데이터와 통계 및 머신러닝 알고리즘을 이용하여 향후 전력 수요를 예측하는 모델을 만들었습니다.
...
- 서울공공데이터 포털에서 제공하는 따릉이 데이터를 이용하여 연령대 별로 사용량 및 사용패턴을 분석하여 개선방안을 제시하였습니다.
...
- 구독형 인터넷 강의 서비스 로그 데이터를 이용하여 사용자들의 리텐션, KPI등 주요 지표를 측정하였고 이탈 방지를 위한 개선방안을 제시하였습니다.
...
- 공유오피스 무료 체험 사용자 로그 데이터와 머신 러닝 알고리즘을 이용하여 사용자들의 행동 패턴을 예측하는 모델을 만들었습니다.
